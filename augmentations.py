...
class ByolAugmentations:
    def __init__(self, img_shape: tuple):
        ...
        self.aug1 = T.Compose(
            base_transforms + [OptionalTransform(T.GaussianBlur, {"kernel_size": 23, "sigma": (0.1, 2.0)}, p=1.0)]
        )

        self.aug2 = T.Compose(
            base_transforms
            + [
                OptionalTransform(T.GaussianBlur, {"kernel_size": 23, "sigma": (0.1, 2.0)}, p=0.1),
